...
var textures = new Textures(texturePack);
var game = new Game('canvas', 600, 800);
var startUp = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, textures.loadTextures()];
            case 1:
                _a.sent();
                game.init();
                return [2 /*return*/];
...
//
// const init = async () => {
//   const element = new Element(textures.test, 50, 50);
//   await element.createModel();
